...
Будем сливать из ветки 2 в ветку 3, посмотрим что получится
Слили ветку ничего не поменялось

Делаем запись в ветке 4, что б отобразилось в графе.

Это сотая запись моего пребывания тут и все стало не очевидно. Давайте закомитем это